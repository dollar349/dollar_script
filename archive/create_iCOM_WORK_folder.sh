...
git clone -b $2 https://ghe.int.vertivco.com/ConvergedSystems/icom-cms.git $FOLDER_NAME 
else
git clone https://ghe.int.vertivco.com/ConvergedSystems/icom-cms.git $FOLDER_NAME 
fi
cd $FOLDER_NAME && \
