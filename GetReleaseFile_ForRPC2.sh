...
cp -raf ${FOLDER_PATH}/rpc2k/build-rpc2k/tmp/deploy/images/RPC2_*_AppFwUpdt.bin  ${RELEASE_FOLDER}/.
cp -raf ${FOLDER_PATH}/rpc2k/build-rpc2k/tmp/deploy/images/RPC2_*_BootFw.bin  ${RELEASE_FOLDER}/.
